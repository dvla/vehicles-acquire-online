...
//                                    dateService: DateService
  ...
  def present = Action { implicit request =>
    request.cookies.getModel[TraderDetailsModel] match {
      ...
      case None =>
// TODO : Reinstate the redirect when the cookie code is in place in the trader details screen
  ...
  def exit = Action { implicit request =>
    form.bindFromRequest.fold(
      invalidForm => Ok(views.html.acquire.success()), //ToDo replace with redirect to next controller when implemented
...
//                  surveyUrl(request),
      ...
      validForm => {
        Future(Ok(views.html.acquire.success())) //ToDo replace with redirect to next controller when implemented
