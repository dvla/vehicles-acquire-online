...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.12.1" % "test" withSources() classifier "tests" withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehiclesAcquireFulfilProject = vehiclesAcquireFulfil("0.5").disablePlugins(PlayScala, SassPlugin, SbtWeb)
