...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.37" % "test" withSources() classifier "tests" withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehiclesAcquireFulfilProject = vehiclesAcquireFulfil("0.15").disablePlugins(PlayScala, SbtWeb)
