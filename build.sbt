...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.34" % "test" withSources() classifier "tests" withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehiclesAcquireFulfilProject = vehiclesAcquireFulfil("0.14").disablePlugins(PlayScala, SbtWeb)
