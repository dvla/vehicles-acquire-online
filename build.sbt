...
libraryDependencies ++= Seq(
  ...
  "dvla" %% "vehicles-presentation-common" % "2.36-SNAPSHOT" % "test" withSources() classifier "tests" withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehiclesAcquireFulfilProject = vehiclesAcquireFulfil("0.15-SNAPSHOT").disablePlugins(PlayScala, SbtWeb)
