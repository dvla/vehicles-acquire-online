...
libraryDependencies ++= Seq(
  cache,
  filters,
  "dvla" %% "vehicles-presentation-common" % "2.24" withSources() withJavadoc() exclude("junit", "junit-dep"),
  "dvla" %% "vehicles-presentation-common" % "2.24" % "test" withSources() classifier "tests" withJavadoc() exclude("junit", "junit-dep"),
...
lazy val vehiclesAcquireFulfilProject = vehiclesAcquireFulfil("0.9").disablePlugins(PlayScala, SbtWeb)
