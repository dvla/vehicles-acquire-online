...
object Sandbox extends Plugin {
  final val VersionOsAddressLookup = "0.5"
  final val VersionVehiclesLookup = "0.4"
  final val VersionVehiclesAcquireFulfil = "0.2"
...
//  lazy val sandboxedProjects = Seq(osAddressLookup, vehiclesLookup, vehicleAndKeeperLookup, legacyStubs)
  ...
  lazy val testGatlingTask = testGatling := {
    ...
    // Happy paths
    simulation("uk.gov.dvla.acquire.simulations.happy.BeforeYouStart")
  }
